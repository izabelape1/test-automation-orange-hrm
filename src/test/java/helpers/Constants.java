...
public class Constants {
    ...
    public static final String MIDDLE_NAME = "Pola";
    public static final String LAST_NAME = "Kowalska";
    public static final String COMPANY_NAME = "DPS";
    public static final String JOB_TITLE = "Manual tester";
    public static final String COMMENT = "Hello world!";
